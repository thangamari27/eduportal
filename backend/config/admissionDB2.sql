...
-- CREATE DATABASE
-- ===========================
DROP DATABASE IF EXISTS admission_db1;
...
CREATE TABLE users (
    ...
    student_id VARCHAR(20) UNIQUE, -- FK to personal_info
...
CREATE TABLE academic_info (
    academic_id VARCHAR(40) PRIMARY KEY, -- allow longer IDs
...
-- ===========================
-- FOREIGN KEY LINK: users.student_id → personal_info.student_id
-- (Add AFTER both tables exist and data is valid)
-- ===========================
ALTER TABLE users
